...
import '../Daily Journals/journal_1.dart';
import '../Surey/Widgets/next_btn.dart';

class Notification5 extends StatefulWidget {
  const Notification5({super.key});

  @override
  State<Notification5> createState() => _Notification5State();
}

class _Notification5State extends State<Notification5> {
  @override
              ...
              child: Nextbtn(
                  ontap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const Journal1()));
                  },
                  name: 'Apply'),
            )
          ]),
